          ...
          {showWelcome ? (
            <div className="text-center py-12">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center mx-auto mb-3">
                ...
                <div className="text-center">
                  <div className="w-8 h-8 rounded-lg bg-purple-100 flex items-center justify-center mx-auto mb-3">
